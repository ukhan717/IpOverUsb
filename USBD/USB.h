...
/* USB system version */
#define USB_VERSION  31900 // Format: Mmmrr Example: 31802UL is 3.18b
...
typedef struct _USB_ADD_EP_INFO {
  U8        Flags;            // Specifies whether optional parameters are used.
                              ...
                              // * USB_ADD_EP_FLAG_USE_ISO_SYNC_TYPES - Use ISO_Types.
  ...
  U8        ISO_Types;        // Allows to set the synchronization type for isochronous endpoints.
...
extern const USB_HW_DRIVER USB_Driver_NXP_iMXRT105x;
